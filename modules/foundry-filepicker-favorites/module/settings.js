...
Hooks.once('ready', async function () {
    let oldSetting = game.settings.get("foundry-filepicker-favorites", "favorites-location");
...
class FavoritesForm extends FormApplication {
    constructor() {
...
class SearchForm extends FormApplication {
    constructor() {
    ...
    _toArray(value) {
        if (value) {
            ...
            if (flat.excludes) {
                let result = Object.values(flat.excludes);
                return result;
            }
        }
        return [];
