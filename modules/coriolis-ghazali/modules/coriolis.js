...
Hooks.on("init", () => {
  ...
  game.settings.registerMenu(moduleScopeKey, "import", {
    ...
    label: "Import",
    hint: "Welcome to the Coriolis - Last Voyage of the Ghazali Scenario Module!  Click above to import the content to your world.",
...
<h1>Last Voyage of the Ghazali</h1>
<hr />
<p>This will import the following Coriolis Last Voyage of the Ghazali content into your world and organize them into folders:</p>
<ul>
<li>21 Actors (NPCs)</li>
<li>36 Items (talents, gear, weapons, etc)</li>
<li>24 Journal entries (full scenario)</li>
<li>11 Scenes (maps, locations, handouts, etc)</li>
<li>2 rolltables (scenario events)</li>
</ul>
...
<div class="coreCenteredImageContainer"><img src="modules/coriolis-ghazali/images/logos.webp" /></div>
</div>
</div>
</div>
`,
          ...
          initialize: {
            ...
            callback: async () => {
              ...
              ui.notifications.notify(
                "Coriolis Last Voyage of the Ghazali Scenario import completed successfully.",
              );
            },
          },
          cancel: {
