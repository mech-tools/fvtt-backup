...
Hooks.on("init", () => {
  ...
  game.settings.registerMenu(moduleScopeKey, "import", {
    ...
    label: "Import",
    hint: "Welcome to the Coriolis - The Last Cyclade!  Click above to import the content to your world.",
...
<h1>The Last Cyclade</h1>
<hr />
<p>This will import the following Coriolis The Last Cyclade content into your world and organize them into folders:</p>
<ul>
<li>188 Items (armor, gear, talents, weapons, injuries, ship features, ship modules, ship problems, etc)</li>
<li>94 Journal entries</li>
<li>52 Actors (Beasts, djinni, NPCs, ships)</li>
<li>14 Rollable tables (critical injuries, failure tables, encounters, faction names, etc)</li>
<li>13 Scenes (maps, locations, and player handouts)</li>
</ul>
...
<div class="coreCenteredImageContainer"><img src="modules/coriolis-lastcyclade/images/logos.webp" /></div>
</div>
</div>
</div>
`,
          ...
          initialize: {
            ...
            callback: async () => {
              ...
              ui.notifications.notify(
                "Coriolis The Last Cyclade import completed successfully.",
              );
            },
          },
          cancel: {
...
async function showIntro() {
  setTimeout(() => {
    try {
      game.scenes.getName("Coriolis - The Last Cyclade").activate();
      game.journal.getName("00 - Index").show();
