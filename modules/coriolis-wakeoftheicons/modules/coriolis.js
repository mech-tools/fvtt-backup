...
Hooks.on("init", () => {
  ...
  game.settings.registerMenu(moduleScopeKey, "import", {
    ...
    label: "Import",
    hint: "Welcome to the Coriolis - Wake of the Icons!  Click above to import the content to your world.",
...
<h1>Wake of the Icons</h1>
<hr />
<p>This will import the following Coriolis Wake of the Icons content into your world and organize them into folders:</p>
<ul>
<li>147 Items (armor, gear, talents, weapons, injuries, ship features, ship modules, ship problems, etc)</li>
<li>96 Journal entries</li>
<li>52 Actors (Beasts, djinni, NPCs, ships)</li>
<li>10 Rollable tables (critical injuries, failure tables, encounters, faction names, etc)</li>
<li>17 Scenes (maps, locations, and player handouts)</li>
</ul>
...
<div class="coreCenteredImageContainer"><img src="modules/coriolis-wakeoftheicons/images/logos.webp" /></div>
</div>
</div>
</div>
`,
          ...
          initialize: {
            ...
            callback: async () => {
              ...
              ui.notifications.notify(
                "Coriolis Wake of the Icons import completed successfully.",
              );
            },
          },
          cancel: {
...
async function showIntro() {
  setTimeout(() => {
    try {
      game.scenes.getName("Coriolis - Wake of the Icons").activate();
      game.journal.getName("00 - Index - WotI").show();
