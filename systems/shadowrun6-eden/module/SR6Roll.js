...
import { SR6ChatMessageData, ReallyRoll, RollType } from "./dice/RollTypes.js";
/**
 *
 */
export default class SR6Roll extends Roll {
    ...
    evaluate(options) {
        ...
        if (this.configured.buttonType === ReallyRoll.AUTOHITS) {
            ...
            let die = new Roll(this._formula).evaluate({ async: false });
...
//# sourceMappingURL=SR6Roll.js.map