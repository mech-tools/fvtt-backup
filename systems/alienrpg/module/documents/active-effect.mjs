 ...
 * @import AlienRPGActor from "./actor.mjs";
 */
...
export default class AlienRPGActiveEffect extends foundry.documents.ActiveEffect {
   ...
   * @param {AlienRPGActor} actor      The actor to check against for rendering.
  ...
  static async _fromStatusEffect(statusId, effectData, options) {
    ...
    if (ALIENRPG.CONFIG.conditions[statusId]?.targeted) await AlienRPGActiveEffect.targetedConditionPrompt(statusId, effectData);
  ...
  //     }
  //   } catch (error) {
  //     ui.notifications.warn("ALIENRPG.ActiveEffect.TargetedConditionPrompt.Warning", { localize: true });
  //   }
  // }
   ...
   * @param {AlienRPGActor} affected The actor affected by the status.
   * @param {AlienRPGActor} source The actor imposing the status.
