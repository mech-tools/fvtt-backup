...
export default class alienrpgSpacecraft extends alienrpgActorBase {
  ...
  static defineSchema() {
    ...
    schema.general = new fields.SchemaField({
      ...
      critMin: new fields.SchemaField({
        value: new fields.NumberField({
          ...requiredInteger,
          initial: 0,
          min: 0,
      ...
      critMaj: new fields.SchemaField({
        value: new fields.NumberField({
          ...requiredInteger,
          initial: 0,
          min: 0,
  ...
  prepareDerivedData() {
    ...
    for (const [skey, Attrib] of Object.entries(this.parent.items.contents)) {
      if (Attrib.type === "spacecraft-crit") {
        switch (Attrib.system.header.type.value) {
          case "0":
            myCritMin++;
            break;
          case "1":
    ...
    this.general.critMin.value = myCritMin;
    this.general.critMaj.value = myCritMaj;
  }
