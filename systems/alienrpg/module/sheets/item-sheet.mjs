  ...
  _configureRenderOptions(options) {
    ...
    switch (this.document.type) {
      ...
      case "talent":
        ...
        options.parts = ["header", "tabs", "talent", "notes"];
        break;
  ...
  async _preparePartContext(partId, context) {
    switch (partId) {
      ...
      case "weapon":
        ...
        context.enrichedComment = await foundry.applications.ux.TextEditor.enrichHTML(this.item.system.attributes.comment.value, {
      ...
      case "talent":
        context.tab = context.tabs[partId];
        context.enrichedComment = await foundry.applications.ux.TextEditor.enrichHTML(this.item.system.general.comment.value, {
          // Whether to show secret blocks in the finished html
          secrets: this.document.isOwner,
          // Data to fill in for inline rolls
          rollData: this.item.getRollData(),
      ...
      case "critical-injury":
        context.tab = context.tabs[partId];
        context.enrichedEffect = await foundry.applications.ux.TextEditor.enrichHTML(this.item.system.attributes.effects, {
          // Whether to show secret blocks in the finished html
          secrets: this.document.isOwner,
          // Data to fill in for inline rolls
          rollData: this.item.getRollData(),
      ...
      case "planet-description":
        context.tab = context.tabs[partId];
        context.enrichedDescription = await foundry.applications.ux.TextEditor.enrichHTML(this.item.system.misc.description.value, {
          // Whether to show secret blocks in the finished html
          secrets: this.document.isOwner,
          // Data to fill in for inline rolls
          rollData: this.item.getRollData(),
